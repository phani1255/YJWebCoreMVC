...
namespace YJWebCoreMVC.Models
{
    public class AnalyticsModel
    {
        ...
        public IEnumerable<AnalyticsModel> getAllSoldorInStockList { get; set; }
        public IEnumerable<AnalyticsModel> getBestSellerCategoryReport { get; set; }
        public IEnumerable<AnalyticsModel> getBestSellerReport { get; set; }
        public IEnumerable<AnalyticsModel> getWorstSellerReport { get; set; }
        public IEnumerable<AnalyticsModel> getAnnualPaymentsReceived { get; set; }
        public IEnumerable<AnalyticsModel> getAnnualSalesComparison { get; set; }
        public IEnumerable<AnalyticsModel> getEndofMonth { get; set; }
        public IEnumerable<AnalyticsModel> getTotalMonthlySales { get; set; }
        public IEnumerable<AnalyticsModel> getTotalMonthlySalesForACustomer { get; set; }
