...
namespace YJWebCoreMVC.Controllers
{
    ...
    //    public IActionResult GetWorstSellerReport(string ccode, string fdate, string tdate, string category, string subcat, string metalval, string brandval, string fromstyle, string tostyle, string strVendor, string groupval)
    //    {
